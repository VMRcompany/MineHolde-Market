...
import { CURSEFORGE_MODS } from './products/curseforgeMods';

export { CREATORS, resolveCreator } from './creatorsData';
export { PROMOTIONS } from './promotionsData';
export { CURSEFORGE_MODS } from './products/curseforgeMods';

// Generate comprehensive expanded library with CurseForge mods strictly at the TOP
function generateFullCatalog(): ProductItem[] {
  const baseList: ProductItem[] = [
    ...CURSEFORGE_MODS, // Top priority: latest CurseForge mods and textures
    ...ADDON_PRODUCTS,
    ...MASHUP_PRODUCTS,
    ...WORLD_PRODUCTS,
    ...SKIN_PRODUCTS,
