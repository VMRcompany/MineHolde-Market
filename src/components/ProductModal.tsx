...
export const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const itemEdition = product ? (product.edition || detectProductEdition(product)) : 'bedrock';
  const isJava = itemEdition === 'java';
            ...
            <div className="lg:col-span-5 flex flex-col justify-between mc-panel p-4 bg-[#232426]">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="mc-panel-dark p-2 flex items-center gap-2">
                    <ShieldCheck className={`w-4 h-4 ${isJava ? 'text-[#f87171]' : 'text-[#82d458]'}`} />
                    <div>
                      <div className="text-[10px] text-[#777]">Издание</div>
                      <div className={`font-bold ${isJava ? 'text-[#fca5a5]' : 'text-white'}`}>
                        {editionLabel}
                      </div>
                    </div>
                  </div>
