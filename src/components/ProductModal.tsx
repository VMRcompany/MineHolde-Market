...
import { getMinecraftSvgFallback } from '../utils/imageFallback';
...
export const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const editionLabel = 'Java Edition';

  // Reset active image index and update SEO tags whenever product changes
  useEffect(() => {
  ...
  // Natural gallery list starting with primary pack thumbnail/avatar
  const galleryImages = [
  ...
  const handleShare = async () => {
    ...
    // Determine category: skins vs mods
    const isSkin =
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 space-y-3">
              ...
              <div
                className="aspect-video w-full mc-panel-dark overflow-hidden relative group bg-[#111112] border-2 border-[#333] cursor-pointer"
                onClick={() => {
                  soundManager.playClick();
              ...
              >
                <img
                  src={activeImage}
                  alt={product.title}
                  className="w-full h-full object-cover select-none transition-all duration-200 group-hover:scale-[1.02]"
                  onError={(e) => {
                ...
                <button
                  ...
                  className="absolute bottom-3 right-3 z-10 flex items-center space-x-1.5 px-2.5 py-1.5 bg-black/80 hover:bg-black text-white text-xs font-minecraft border border-zinc-500 hover:border-[#a4f576] shadow-lg transition-colors cursor-pointer"
                  title="Открыть в полный экран"
                >
                  <Maximize2 className="w-3.5 h-3.5 text-[#a4f576]" />
            ...
            <div className="lg:col-span-5 flex flex-col justify-between mc-panel p-4 bg-[#232426]">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="mc-panel-dark p-2 flex items-center gap-2">
                    ...
                    <div>
                      <div className="text-[10px] text-[#777]">Издание / Платформа</div>
                      <div className="font-bold text-[#a4f576]">
                        Java Edition (ПК)
                      </div>
                    </div>
                  </div>
              ...
              <div className="pt-4 border-t-2 border-[#333] mt-4 space-y-3">
                {/* Download and free status Banner */}
                <div className="mc-panel-dark p-3 space-y-2 border border-[#444]">
                  <div className="flex items-center justify-between text-xs text-[#9a9a9f]">
                    ...
                    <span className="text-[#a4f576] font-bold text-sm">
                      Полный открытый доступ (Java Edition)
                    </span>
                  </div>
                ...
                {isOwned ? (
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <span>Выбрать версию и скачать ({product.downloadSize})</span>
                    </button>
                  ...
                  >
                    ...
                    <span>СКАЧАТЬ БЕСПЛАТНО ДЛЯ JAVA EDITION</span>
                  </button>
                )}
          ...
          <div className="mc-panel-dark p-3 text-xs flex flex-wrap items-center justify-between gap-3 text-[#8e8e93]">
            ...
            <div className="text-[11px] text-[#aaa]">
              Формат: {editionLabel} {product.version}
            </div>
          </div>
        </div>
      </div>
